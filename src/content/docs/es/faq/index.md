...
## ¿Puede el chat cambiar mi plan de entrenamiento de verdad?

**Sí — y esta es la parte que la mayoría se pierde.** El coach del chat tiene herramientas para modificar tu plan, intercambiar sesiones, actualizar objetivos y escribir notas en tu nombre. Puedes decir:

- *"Mueve los intervalos de mañana a viernes."*
- *"Estoy de viaje el miércoles, sustituye la sesión de gimnasio por algo que pueda hacer en una habitación de hotel."*
- *"Quiero bajar la intensidad el resto de la semana — me siento regular."*
- *"Cambia mi objetivo a una maratón el 12 de octubre en lugar de la media."*

El coach mira los datos relevantes, hace los cambios y te dice qué hizo. No hace falta salir del chat para actuar sobre la conversación.
...
Son la entrada a tu **motor de insights personalizados**. Cada nota, audio, foto o respuesta del check-in se transforma en etiquetas de hábito, se cruza con lo que hizo tu cuerpo en las siguientes 24–48 horas y se analiza en una ventana de 90 días. La salida son patrones estadísticamente significativos en *tus* datos — *"La cafeína tarde se asocia con un 28% menos de sueño profundo para ti"* o *"Los días con frío muestran mejor recuperación al día siguiente."* Cuanto más constante registres, más rápido y más afilados los insights.

## ¿Cuánto tarda en aparecer el primer insight personalizado?

Unas **dos a tres semanas** de registro constante. El motor necesita suficientes días en los que hiciste algo *y* suficientes en los que no para encontrar una diferencia significativa — típicamente 8–12 de cada. Verás tus seis métricas y el coaching diario desde el primer día; los insights personales aparecen progresivamente conforme se acumulan datos.
...
**Perfil → Borrar todos los datos** elimina todo lo que Corpus tiene en tu dispositivo. También puedes revocar permisos individuales de Apple Salud en **Ajustes → Salud → Apps → Corpus**, o borrar notas, fotos y respuestas del check-in concretas desde la pantalla principal. Como nada se guarda en servidor, eso es todo. Mira [Borrar tus datos](/es/docs/privacy-control/deleting-your-data).

## ¿Qué modelos de Apple Watch están soportados?

Series 4 en adelante. Series 3 no está soportado por las versiones recientes de watchOS de las que depende Corpus.

## Tengo otra pregunta

Escribe a [dvpuchades@gmail.com](mailto:dvpuchades@gmail.com) — leo cada mensaje.

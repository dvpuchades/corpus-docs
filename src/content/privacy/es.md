...
Corpus existe para ayudarte a entender tu cuerpo. Esa misión sólo funciona si confías en nosotros con tus datos — así que construimos Corpus en torno a un único principio: **tus datos de salud son tuyos.**
...
El responsable del tratamiento de Corpus es **David Puchades Todolí**. Las consultas de privacidad y las solicitudes sobre derechos pueden enviarse a [dvpuchades@gmail.com](mailto:dvpuchades@gmail.com).
...
- **Objetivos y preferencias** — los que defines en el onboarding y actualizas con el tiempo.
- **Registros de hábitos** — respuestas del check-in, notas, fotos y etiquetas que aportes.
- **Mensajes del chat** — conversaciones con tu coach de IA.
- **Agenda laboral** — usada para planificar entrenamientos en torno a tu disponibilidad.
- **Nombre** — opcional, usado sólo para personalizar tu coaching.
...
Cuando haces una foto para registrar un hábito, se envía al servicio de IA para análisis — para describir lo que hay en ella y extraer etiquetas relevantes (por ejemplo identificar comidas en una foto). La imagen se procesa de forma transitoria y **no se guarda en remoto**. La foto original se guarda sólo en tu dispositivo.

## Tus derechos

Estás al mando de tus datos en todo momento:

- **Borrar todos los datos** — Desde Perfil puedes borrar todos los datos almacenados en tu dispositivo.
- **Revocar permisos de Salud** — Ajusta qué categorías de Apple Salud puede acceder Corpus en cualquier momento desde *Ajustes → Salud → Apps → Corpus*.
- **Borrar entradas individuales** — Quita notas, fotos o registros concretos desde tu pantalla principal.
- **Acceso y rectificación** — Como todos los datos viven en tu dispositivo, puedes verlos y editarlos directamente en la app.
- **Contacto por correo** — Para cualquier consulta sobre derechos, escribe a [dvpuchades@gmail.com](mailto:dvpuchades@gmail.com).

## Edad mínima

Corpus está diseñado para usuarios de 17 años o más.

## Lo que Corpus no hace

- **Sin funciones sociales.** No hay perfiles, feeds, rankings ni mecanismos de compartir.
- **Sin cuenta requerida.** Corpus funciona enteramente en tu dispositivo, sin registro ni login.
- **Sin venta de datos.** Tus datos de salud no se venden, no se comparten con anunciantes y no se usan para nada salvo generar tu coaching personal.
- **Sin analíticas de terceros.** No rastreamos cómo usas la app con servicios externos.

## Cambios en esta política

Podemos actualizar esta política de vez en cuando. Los cambios se reflejarán con una fecha actualizada al principio de esta página. Seguir usando Corpus tras los cambios constituye la aceptación de la política actualizada.

## Contacto

Si tienes preguntas sobre cómo Corpus trata tus datos, escribe al desarrollador a [dvpuchades@gmail.com](mailto:dvpuchades@gmail.com).

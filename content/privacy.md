...
description: How Corpus handles your health data, what stays on your device, and what controls you have.
slug: /privacy
sidebar_position: 5
---
...
Corpus exists to help you understand your body. That mission only works if you trust us with your data. So we built Corpus around a simple principle: **your health data is yours.**
...
- **Menstrual cycle** — Flow data used for automatic behaviour logging when available.
...
- **Name** — Optional, used only to personalize your coaching.
...
- Your behaviour logs, notes, and photos
- Your personalized insights and correlations
...
- **Revoke health permissions** — Adjust which Apple Health categories Corpus can access at any time through your device's Health settings.
...
- **No account required.** Corpus works entirely on your device without requiring sign-up or login.
...
If you have questions about how Corpus handles your data, contact the developer at [dvpuchades@gmail.com](mailto:dvpuchades@gmail.com).
